...
-}
data ConstantSampler = ConstantSampler'_constructor
...
-}
data RateLimitingSampler = RateLimitingSampler'_constructor
              ...
              case tag of
                ...
                10 ->
                  do
                    ...
                    loop
                      ( Lens.Family2.set
                          (Data.ProtoLens.Field.field @"constantSampler")
                          y
                          x
                      )
                18 ->
                  do
                    ...
                    loop
                      ( Lens.Family2.set
                          (Data.ProtoLens.Field.field @"traceIdRatioBased")
                          y
                          x
                      )
                26 ->
            ...
            ( (Data.Monoid.<>)
                ...
                ( (Data.Monoid.<>)
                    ...
                    ( (Data.Monoid.<>)
                        ...
                        ( (Data.Monoid.<>)
                            ( case Lens.Family2.view (Data.ProtoLens.Field.field @"maybe'sampler") _x of
...
-}
data TraceIdRatioBased = TraceIdRatioBased'_constructor
