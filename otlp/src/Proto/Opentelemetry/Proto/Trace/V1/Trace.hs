...
-}
data InstrumentationLibrarySpans = InstrumentationLibrarySpans'_constructor
            ...
            then do
              ...
              Prelude.return
                ( Lens.Family2.over
                    ...
                    (\ !t -> Prelude.reverse t)
                    ( Lens.Family2.set
                        (Data.ProtoLens.Field.field @"vec'spans")
                        frozen'spans
                        x
                    )
                )
...
-}
data ResourceSpans = ResourceSpans'_constructor
    ...
    let
      ...
      loop x mutable'instrumentationLibrarySpans =
        do
          ...
          if end
            then do
              frozen'instrumentationLibrarySpans <-
                Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
...
instance Data.ProtoLens.Field.HasField Span "traceState" Data.Text.Text where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'traceState
          (\x__ y__ -> x__ {_Span'traceState = y__})
      )
      Prelude.id
...
instance Data.ProtoLens.Field.HasField Span "parentSpanId" Data.ByteString.ByteString where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'parentSpanId
          (\x__ y__ -> x__ {_Span'parentSpanId = y__})
      )
      Prelude.id
...
instance Data.ProtoLens.Field.HasField Span "attributes" [Proto.Opentelemetry.Proto.Common.V1.Common.KeyValue] where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'attributes
          (\x__ y__ -> x__ {_Span'attributes = y__})
      )
      ( Lens.Family2.Unchecked.lens
          Data.Vector.Generic.toList
          (\_ y__ -> Data.Vector.Generic.fromList y__)
...
-}
data Span'Event = Span'Event'_constructor
...
instance Data.ProtoLens.Field.HasField Span'Event "name" Data.Text.Text where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'Event'name
          (\x__ y__ -> x__ {_Span'Event'name = y__})
      )
      Prelude.id
...
-}
data Span'Link = Span'Link'_constructor
...
instance Data.ProtoLens.Field.HasField Span'Link "traceId" Data.ByteString.ByteString where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'Link'traceId
          (\x__ y__ -> x__ {_Span'Link'traceId = y__})
      )
      Prelude.id
...
instance Data.ProtoLens.Field.HasField Span'Link "spanId" Data.ByteString.ByteString where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Span'Link'spanId
          (\x__ y__ -> x__ {_Span'Link'spanId = y__})
      )
      Prelude.id
...
instance Prelude.Enum Span'SpanKind where
  toEnum k__ =
    Prelude.maybe
      ( Prelude.error
          ( (Prelude.++)
              "toEnum: unknown value for enum SpanKind: "
              (Prelude.show k__)
          )
      )
      Prelude.id
...
-}
data Status = Status'_constructor
...
instance Data.ProtoLens.Field.HasField Status "message" Data.Text.Text where
  fieldOf _ =
    (Prelude..)
      ( Lens.Family2.Unchecked.lens
          _Status'message
          (\x__ y__ -> x__ {_Status'message = y__})
      )
      Prelude.id
...
instance Prelude.Enum Status'StatusCode where
  toEnum k__ =
    Prelude.maybe
      ( Prelude.error
          ( (Prelude.++)
              "toEnum: unknown value for enum StatusCode: "
              (Prelude.show k__)
          )
      )
      Prelude.id
...
-}
data TracesData = TracesData'_constructor
